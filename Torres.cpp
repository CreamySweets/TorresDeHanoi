...
void Torres::empezar() {
    ...
    std::cin >> columnas;
    tablero = (int*)malloc(sizeof(int) * filas * columnas); //reserva un bloque de memoria del tamaño de filas y columnas
    iniciarJuego();
}
...
void Torres::imprimirEspacios(int i, int espacios) {
    if (i == espacios) {
    }
    else {
        std::cout << " ";
